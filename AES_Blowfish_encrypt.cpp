...
public:
    Blowfish() {
        // Initialization of S-boxes (assumed to be done here)
    }
...
int main()
{
    ...
    const std::string outputFileName = "output_aes_blowfish_encrypt.txt"; // Output file with separate headings for AES and Blowfish
    ...
    // Writing to the output file with separate headings
    ...
    // Heading for AES Output
    outputFile << "Encryption Output:\n";
    outputFile.write(reinterpret_cast<const char *>(aesEncryptedData.data()), aesEncryptedData.size());

    // Heading for Blowfish Output
    outputFile << "\n\nEncryption Output:\n";
    outputFile.write(reinterpret_cast<const char *>(blowfishEncryptedData.data()), blowfishEncryptedData.size());
